        ...
        <div class="col-md-6 mb-30">
            <div class="report-card d-flex flex-wrap align-items-center">
                ...
                <div class="content">
                    ...
                    @if ($perDay)
                        <p class="card-text font-weight-bold">{{$general->cur_sym}}{{getAmount($perDay->sum('amount'),4)}}</p>
                        <p class="card-text"><small
                                class="text-muted">@lang('Last updated '){{diffForHumans($perDay->latest()->first()->updated_at??'0 sec ago')}}</small>
                        </p>
                    @else
