            ...
            <div class="form-wrapper">
                ...
                <form action="{{ route('admin.login') }}" method="POST" class="cmn-form mt-30">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" class="form-control b-radius--capsule" id="username" value="admin" placeholder="@lang('Enter your username')">
                        <i class="las la-user input-icon"></i>
                    </div>
                    <div class="form-group">
                        <label for="pass">@lang('Password')</label>
                        <input type="password" name="password" class="form-control b-radius--capsule" id="pass" value="admin" placeholder="@lang('Enter your password')">
